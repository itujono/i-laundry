  ...
  <div class="md-card">
    <div class="md-card-content">
      <ul class="uk-tab uk-tab-grid" data-uk-tab="{connect:'#tabs_4'}">
        <li class="uk-width-1-2 <?php echo $tab['data-tab']?>>"><a href="#">Daftar Servis</a></li>
        <li class="uk-width-1-2 <?php echo $tab['form-tab']?>"><a href="#">Form Servis</a></li>
      </ul>
      ...
      <!-- START LIST SERVICES -->
          ...
          <table id="dt_individual_search" class="uk-table" cellspacing="0" width="100%">
            ...
            <?php foreach ($listservices  as $key => $services) { 
             ...
             <tr>
                ...
                <td>Rp. <?php echo number_format($services->pricesSERVICES, 0, ".", ".");?></td>
        ...
        <!-- START FORM INPUT SERVICES -->
        <li>
          <h3 class="heading_a uk-margin-bottom">Tambah atau perbaharui servis</h3>
                ...
                <div class="uk-form-row">
                  <div class="uk-grid" data-uk-grid-margin>
                    ...
                    <div class="uk-width-medium-1-3">
                      ...
                      <input required class="md-input label-fixed" name="pricesSERVICES" type="number" value="<?php echo $getservices->pricesSERVICES;?>" />
                      <p class="text-red"><?php echo form_error('pricesSERVICES'); ?></p>
                    </div>
                    ...
                    <div class="uk-width-medium-1-3 uk-margin-top">
                      <div class="parsley-row">
                        ...
                        <label for="switch_demo_large" class="inline-label"><b>Aktifkan Servis</b></label>
                      </div>
                    </div>
                  </div>
