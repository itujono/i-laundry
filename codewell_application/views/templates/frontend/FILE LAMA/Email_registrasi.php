		    ...
		    <center style="width: 100%;">
		       ...
		       <div style="margin: 20px 0 20px 0">
		        ...
		        <table cellspacing="0" cellpadding="0" border="0" align="center" bgcolor="#ffffff" width="600" class="email-container">
		            ...
		            <tr>
		                <tr>
		                    <td style="padding: 20px 40px 0 40px; font-weight: bold; text-align: left; font-family: sans-serif; font-size: 20px; mso-height-rule: exactly; line-height: 20px; color: #555555;">Selamat Datang, Riva!</td>
		                </tr>
		                    <td style="padding: 10px 20px 0px 40px; text-align: left; font-family: sans-serif; font-size: 12px; mso-height-rule: exactly; line-height: 20px; color: #555555;">
		                        Tinggal sedikit lagi agar kamu bisa bergabung di i-Laundry. Silakan klik tautan di bawah ini dan akhiri perjalanan panjang baju kotormu.
		                        <br>
		                    </td>
		            </tr>
		            <tr id="btn-confirm">
