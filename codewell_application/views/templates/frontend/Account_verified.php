            ...
            <div id="pages_maincontent">
                <div class="main-text layout_fullwidth_padding">
                    <div class="settings-title">
                        <img src="<?php echo base_url().$this->data['asfront']; ?>images/icons/white/drink.png" alt="Completed">
                        <h2>Yippieee! Selamat bergabung!</h2>
                        <p>Akun i-Laundry kamu sudah berhasil diverifikasi. Artinya, mulai sekarang silakan kamu bersantai saja, sementara kami yang akan ambil-alih semua pakaian kotor kamu.</p>
                    </div>
                </div>
                <div class="back-to-home round">
                    <a href="<?php echo base_url();?>Home">Baik, saya mau nyuci sekarang</a>
                </div>
            </div>
