$(function() {
    kendoUI.autocomplete_widget(), kendoUI.calendar_widget(), kendoUI.color_picker_widget(),
        kendoUI.combobox_widget(), kendoUI.datepicker_widget(), kendoUI
        .datetimepicker_widget(), kendoUI.dropdownList_widget(),
        kendoUI.masked_input_widget(), kendoUI.menu_widget(), kendoUI.multiselect_widget(),
        kendoUI.numeric_textbox_widget(), kendoUI.panelbar_widget(),
        kendoUI.timepicker_widget(), kendoUI.toolbar_widget(), kendoUI.window_widget()
}), kendoUI = {
    autocomplete_widget: function() {
        var e = $("#kUI_automplete");
        if (e.length) var t = ["Albania", "Andorra", "Armenia",
    ...
    color_picker_widget: function() {
        function e(e) {
            $(".icon_preview").find(".material-icons").css("color",
                e.value)
        }
    ...
    datetimepicker_widget: function() {
        function e() {
            var e = d.value(),
                t = r.value();
            e ? (e = new Date(e), e.setDate(e.getDate()), r.min(e)) :
                t ? d.max(new Date(t)) : (t = new Date, d.max(t), r
                    .min(t))
        }
        ...
        function t() {
            var e = r.value(),
                t = d.value();
            e ? (e = new Date(e), e.setDate(e.getDate()), d.max(e)) :
                t ? r.min(new Date(t)) : (e = new Date, d.max(e), r
                    .min(e))
        }
    ...
    timepicker_widget: function() {
        function e() {
            var e = o.value();
            e && (e = new Date(e), i.max(e), e.setMinutes(e.getMinutes() +
                this.options.interval), i.min(e), i.value(e))
        }
        ...
        if (a.length && n.length) {
            ...
            o.min("8:00 AM"), o.max("6:00 PM"), i.min("8:00 AM"), i.max(
                "7:30 AM")
        }
    },
